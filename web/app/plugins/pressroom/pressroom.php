...
class TPL_Pressroom
{
   ...
   * Update Db Version in WordPress Database
	...
	public function update_db_check() {
		if ( get_site_option( '_pr_table_db_version' ) != PR_TABLE_DB_VERSION ) {
			PR_Setup::setup_db_tables();
		}
	}
	...
	*/
	...
	public function register_pressroom_styles() {
		...
		wp_register_style( 'pressroom', PR_ASSETS_URI . 'css/' . ( defined('WP_DEBUG') && WP_DEBUG ? 'pressroom.css' : 'pressroom.min.css' ) );
