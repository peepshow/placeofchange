    ...
    <div class="wrapper">
        <div class="container">
           <?php 
            ...
            ?>
            <p>
            <strong><?php echo $project[0]->name.', '.$edition->post_title; ?></strong>
            , published on <strong><?php echo date('d F, Y', strtotime($editionmeta['_pr_date'][0])); ?></strong><br>via PressRoon <abbr><?php echo $editionmeta['pr_packager_type'][0]; ?></abbr> exporter. 
            </p>
